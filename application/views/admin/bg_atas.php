...
<div id="templatemo_header_wrapper">
	...
	<div id="myjquerymenu" class="jquerycssmenu">	
		...
		<ul>
			...
			<li><a href="<?php echo base_url(); ?>penduduk/indv"><span>Cari Per-individu</span></a><ul></ul></li>
			<li><a href="<?php echo base_url(); ?>penduduk/cari_rt"><span>Cari Per-RT</span></a><ul></ul></li>
			<li><a href="<?php echo base_url(); ?>penduduk/cari_rw"><span>Cari Per-RW</span></a><ul></ul></li>
			<li><a href="<?php echo base_url(); ?>penduduk/admin"><span>Lis Penduduk</span></a><ul></ul></li>
			<?php
			//	$i = 1;
