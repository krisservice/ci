...
echo "<th width=100 bgcolor=#0f0>Opsi</th>";
echo "</tr>";
$no=1;
$w=1;
...
?>
<td>
<a href="<?= base_url() ?>index.php/penduduk/rincian/<?= $row->nik ?>">RINCIAN</a>|<a href="<?= base_url() ?>index.php/penduduk/updatePenduduk/<?= $row->nik ?>">Update</a>|<a href="<?= base_url() ?>index.php/penduduk/deletePendudukDb/<?= $row->nik ?>">Delete</a>
</td>
<?php
$no++;
}
